...
export default function Privacy() {
  return (
    <div className="w-full min-h-screen text-white/80 py-10 px-4 sm:px-6 md:px-10 lg:px-24 overflow-y-auto">
      <SEO
        title="Politique de confidentialité – BECYCURE"
        description="Découvrez la politique de confidentialité de BECYCURE: gestion des données personnelles, cookies et respect du RGPD."
        ...
        <span className="block">
          <span className="inline-flex items-baseline gap-x-2 md:gap-x-3">
            <GradientText colors={["#40ffaa", "#81fa9fff", "#40ffd6ff", "#40ffafff", "#40ffaa"]} animationSpeed={3}>
              <ScrambleText as="span" text={"/ POLITIQUE DE CONFIDENTIALITÉ"} trigger="mount" duration={300} cyclesPerLetter={4} shuffleMs={120} respectMotion={false} reserveWidth={false} />
            </GradientText>
          </span>
        </span>
      </h1>
      <Panel border="ring-1 ring-green-500/20" padding="p-6 sm:p-8" className="w-full max-w-4xl">
        ...
        <p className="text-gray-200/90 leading-relaxed">
          Ce document présente la manière dont BECYCURE collecte, utilise et protège vos données personnelles.
        </p>
      </Panel>
    </div>
  );
