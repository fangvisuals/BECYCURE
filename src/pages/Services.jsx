...
export default function Integration() {
  return (
    <PageContainer>
      ...
      {/* Contenu principal */}
      <div className="relative z-10 px-6 py-10 max-w-5xl ml-0">
        ...
        <Panel border='ring-1 ring-green-500/20 mt-4 mb-8'>
        <p className="text-lg leading-relaxed text-gray-200 mb-8 pt-4">
        ...
        <Panel border='ring-1 ring-green-500/30'>
